...
export default async function EmployeeClockPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const copy = locale === "ar" ? {
    pageTitle: "الحضور الشخصي", subtitle: "سجّل الحضور والانصراف بإثبات الموقع والصورة وفق سياسة فرعك.", title: "ساعة الحضور", checkIn: "تسجيل الحضور", checkOut: "تسجيل الانصراف", branch: "الفرع", todayShift: "وردية يوم العمل", noShift: "لا توجد وردية منشورة ليوم العمل الحالي.", mobileDisabled: "التسجيل من الهاتف غير مفعّل في هذا الفرع. تواصل مع مسؤول الموارد البشرية.", selfie: "صورة الحضور", selfieRequired: "الصورة مطلوبة قبل التسجيل.", selfieOptional: "الصورة اختيارية حسب سياسة الفرع.", takeSelfie: "فتح الكاميرا الأمامية", replaceSelfie: "إعادة التقاط الصورة", location: "الموقع", locationReady: "تم التقاط موقعك الحالي", locationOnSubmit: "اسمح بالوصول للموقع قبل التسجيل", locationUnavailable: "الموقع غير متاح على هذا الجهاز.", requestLocation: "السماح بالموقع", locationRequesting: "جارٍ تحديد الموقع…", locationDenied: "يجب السماح بالموقع الدقيق من إعدادات المتصفح قبل التسجيل.", locationAccuracy: "دقة الموقع", radius: "النطاق المسموح", online: "متصل", offline: "غير متصل — أعد الاتصال للتسجيل", submitting: "جارٍ التسجيل…", recorded: "تم بنجاح.", pending: "بانتظار موافقة المسؤول", failed: "تعذر تسجيل الحضور.", recent: "آخر التسجيلات", noPunches: "لا توجد تسجيلات حضور بعد.", valid: "معتمد", rejected: "مرفوض", meters: "متر", remove: "إزالة", cameraUnavailable: "تعذر فتح الكاميرا الأمامية. اسمح للمتصفح باستخدام الكاميرا ثم حاول مجددًا.", cameraReady: "تم التقاط صورة الحضور.", captureSelfie: "التقاط الآن", cancel: "إلغاء", noEmployee: "حسابك غير مرتبط بسجل موظف. اطلب من المسؤول ربط الحساب من ملف الموظف.", noBranch: "يجب تعيين فرع للموظف قبل استخدام الحضور من الهاتف.", noPermission: "ليس لديك صلاحية تسجيل الحضور من الهاتف.", employeeProfile: "فتح ملف الموظف",
  } : {
    pageTitle: "My attendance", subtitle: "Clock in and out with location and selfie evidence under your branch policy.", title: "Attendance clock", checkIn: "Clock in", checkOut: "Clock out", branch: "Branch", todayShift: "Workday shift", noShift: "No published shift is assigned for the current workday.", mobileDisabled: "Mobile attendance is disabled for this branch. Contact HR for assistance.", selfie: "Attendance selfie", selfieRequired: "A selfie is required before clocking.", selfieOptional: "A selfie is optional under this branch policy.", takeSelfie: "Open front camera", replaceSelfie: "Retake selfie", location: "Location", locationReady: "Current location captured", locationOnSubmit: "Allow location access before clocking", locationUnavailable: "Location is unavailable on this device.", requestLocation: "Allow location", locationRequesting: "Locating…", locationDenied: "Precise location permission is required. Allow it in your browser settings, then try again.", locationAccuracy: "Location accuracy", radius: "Allowed radius", online: "Online", offline: "Offline — reconnect to clock", submitting: "Recording…", recorded: "recorded successfully.", pending: "Pending manager approval", failed: "Attendance could not be recorded.", recent: "Recent punches", noPunches: "No attendance punches yet.", valid: "Validated", rejected: "Rejected", meters: "metres", remove: "Remove", cameraUnavailable: "The front camera could not be opened. Allow camera access in your browser and try again.", cameraReady: "Attendance selfie captured.", captureSelfie: "Capture now", cancel: "Cancel", noEmployee: "Your account is not linked to an employee record. Ask an administrator to link it from your employee profile.", noBranch: "An employee branch is required before mobile attendance can be used.", noPermission: "You do not have permission to record mobile attendance.", employeeProfile: "Open employee profile",
  };
