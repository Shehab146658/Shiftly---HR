...
export default async function AttendancePage({ params, searchParams }: {
  ...
  const labels = locale === "ar" ? {
    title: "الحضور والانصراف", subtitle: "مواعيد العمل الفعلية والتأخير والإضافي والاستثناءات في تقرير واحد.", devices: "أجهزة البصمة والاستيراد", addPunch: "إضافة بصمة يدوية", addPunchHelp: "استخدمها للتصحيح أو لإدخال سجل موثق من الإدارة.", punchSaved: "تم حفظ البصمة وإعادة حساب اليوم.", savePunch: "حفظ البصمة",
    ...
    title: "Attendance", subtitle: "Actual working times, lateness, overtime, and exceptions in one operational report.", devices: "Fingerprint devices & imports", addPunch: "Add manual punch", addPunchHelp: "Use this for a correction or an administrator-verified attendance event.", punchSaved: "Punch saved and the work day recalculated.", savePunch: "Save punch",
